...
API_zapros = http.get("https://raw.githubusercontent.com/Markushka88/CCStuff/main/Installer/GUI.lua")
...
if not http.get("https://raw.githubusercontent.com/Markushka88/CCStuff/main/Installer/GUI.lua") then
	FancyError()
end
...
Settings = {
	...
	GitHubUsername = 'Markushka88', --Your GitHub username as it appears in the URL
